...
emlrtContext emlrtContextGlobal = {
    ...
    NULL,                                                 /* fErrorFunction */
    "quadcopter_model",                                   /* fFunctionName */
    NULL,                                                 /* fRTCallStack */
    false,                                                /* bDebugMode */
...
void quadcopter_model_api(const mxArray *const prhs[2], const mxArray **plhs)
{
  ...
  dxdt = (real_T(*)[12])mxMalloc(sizeof(real_T[12]));
  /* Marshall function inputs */
  x = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "x");
  u = c_emlrt_marshallIn(&st, emlrtAlias(prhs[1]), "u");
  /* Invoke the target function */
  quadcopter_model(*x, *u, *dxdt);
  /* Marshall function outputs */
  *plhs = emlrt_marshallOut(*dxdt);
}
...
void quadcopter_model_atexit(void)
{
  ...
  quadcopter_model_xil_terminate();
...
/* End of code generation (_coder_quadcopter_model_api.c) */
